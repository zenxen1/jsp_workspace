...
CKEDITOR.lang['bs'] =
{
	...
	link :
	{
		...
		popupFeatures	: 'Mogu챈nosti popup prozora',
	...
	findAndReplace :
	{
		...
		notFoundMsg			: 'Tra탑eni tekst nije prona챨en.',
		findOptions			: 'Find Options', // MISSING
		matchCase			: 'Upore챨uj velika/mala slova',
		matchWord			: 'Upore챨uj samo cijelu rije챔',
	...
	image :
	{
		...
		menu		: 'Svojstva slike',
		infoTab		: 'Info slike',
		btnUpload	: '힋alji na server',
		upload		: '힋alji',
		alt			: 'Tekst na slici',
		lockRatio	: 'Zaklju챔aj odnos',
	...
	{
		title		: 'Zalijepi',
		cutError	: 'Sigurnosne postavke va큄eg pretra탑iva챔a ne dozvoljavaju operacije automatskog rezanja. Molimo koristite kraticu na tastaturi (Ctrl/Cmd+X).',
		copyError	: 'Sigurnosne postavke Va큄eg pretra탑iva챔a ne dozvoljavaju operacije automatskog kopiranja. Molimo koristite kraticu na tastaturi (Ctrl/Cmd+C).',
	...
	pasteText :
	{
		button	: 'Zalijepi kao obi챔an tekst',
		title	: 'Zalijepi kao obi챔an tekst'
	},
