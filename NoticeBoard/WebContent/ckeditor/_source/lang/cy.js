...
CKEDITOR.lang['cy'] =
{
	...
	link :
	{
		...
		targetFrameName	: 'Enw Ffr창m y Targed',
	...
	list:
	{
		...
		decimalLeadingZero	: 'Degol 창 sero arweiniol (01, 02, 03, ayyb.)'
	},
	...
	table :
	{
		...
		cell :
		{
			...
			insertAfter		: 'Mewnosod Cell Ar 횚l',
		...
		row :
		{
			...
			insertAfter		: 'Mewnosod Rhes Ar 횚l',
		...
		column :
		{
			...
			insertAfter		: 'Mewnosod Colofn Ar 횚l',
	...
	select :
	{
		...
		size		: 'Maint',
		lines		: 'llinellau',
		chkMulti	: 'Caniat횪u aml-ddewisiadau',
		opText		: 'Testun',
		opValue		: 'Gwerth',
		btnAdd		: 'Ychwanegu',
		btnModify	: 'Newid',
	...
	{
		title		: 'Gludo',
		cutError	: 'Nid yw gosodiadau diogelwch eich porwr yn caniat횪u\'r golygydd i gynnal \'gweithredoedd torri\' yn awtomatig. Defnyddiwch y bysellfwrdd (Ctrl/Cmd+X).',
		copyError	: 'Nid yw gosodiadau diogelwch eich porwr yn caniat횪u\'r golygydd i gynnal \'gweithredoedd cop챦o\' yn awtomatig. Defnyddiwch y bysellfwrdd (Ctrl/Cmd+C).',
	...
	pastefromword :
	{
		confirmCleanup	: 'Mae\'r testun rydych chi am ludo wedi\'i gop챦o o Word. Ydych chi am ei lanhau cyn ei ludo?',
	...
	scayt :
	{
		...
		mixedCase		: 'Anwybyddu Geiriau 창 Chymysgedd Nodau Uwch ac Is',
		mixedWithDigits	: 'Anwybyddu Geiriau 창 Rhifau',
	...
	docprops :
	{
		...
		charsetCT : 'Tsiein챘eg Traddodiadol (Big5)',
		charsetCR : 'Syrilig',
		charsetGR : 'Groeg',
		charsetJP : 'Siapan챘eg',
		charsetKR : 'Cor챘eg',
