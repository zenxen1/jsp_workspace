...
CKEDITOR.lang['fr-ca'] =
{
	...
	horizontalrule	: 'Ins챕rer un s챕parateur',
	pagebreak		: 'Ins챕rer un saut de page',
	...
	common :
	{
		...
		button			: 'Bouton',
		select			: 'Champ de s챕lection',
		imageButton		: 'Bouton image',
		notSet			: '<Par d챕faut>',
		id				: 'Id',
		name			: 'Nom',
		langDir			: 'Sens d\'챕criture',
		langDirLtr		: 'De gauche 횪 droite (LTR)',
		langDirRtl		: 'De droite 횪 gauche (RTL)',
	...
	specialChar		:
	{
		...
		title		: 'Ins챕rer un caract챔re sp챕cial',
	...
	link :
	{
		toolbar		: 'Ins챕rer/modifier le lien',
		other 		: '<other>', // MISSING
		menu		: 'Modifier le lien',
		title		: 'Propri챕t챕s du lien',
		...
		popupFeatures	: 'Caract챕ristiques de la fen챗tre popup',
		popupResizable	: 'Resizable', // MISSING
		popupStatusBar	: 'Barre d\'챕tat',
		...
		popupLeft		: 'Position 횪 partir de la gauche',
		popupTop		: 'Position 횪 partir du haut',
		id				: 'Id', // MISSING
		langDir			: 'Sens d\'챕criture',
		langDirLTR		: 'De gauche 횪 droite (LTR)',
		langDirRTL		: 'De droite 횪 gauche (RTL)',
		acccessKey		: '횋quivalent clavier',
		name			: 'Nom',
		langCode			: 'Sens d\'챕criture',
		...
		selectAnchor		: 'S챕lectionner une ancre',
		anchorName		: 'Par nom',
		anchorId			: 'Par id',
	...
	anchor :
	{
		toolbar		: 'Ins챕rer/modifier l\'ancre',
		menu		: 'Propri챕t챕s de l\'ancre',
	...
	findAndReplace :
	{
		...
		notFoundMsg			: 'Le texte indiqu챕 est introuvable.',
	...
	select :
	{
		title		: 'Propri챕t챕s de la liste/du menu',
		selectInfo	: 'Info',
		opAvail		: 'Options disponibles',
		value		: 'Valeur',
		size		: 'Taille',
		lines		: 'lignes',
		chkMulti	: 'S챕lection multiple',
		opText		: 'Texte',
		opValue		: 'Valeur',
		btnAdd		: 'Ajouter',
		btnModify	: 'Modifier',
		btnUp		: 'Monter',
		btnDown		: 'Descendre',
		btnSetValue : 'Valeur s챕lectionn챕e',
		btnDelete	: 'Supprimer'
	},
	...
	textfield :
	{
		...
		name		: 'Nom',
		value		: 'Valeur',
		charWidth	: 'Largeur en caract챔res',
	...
	flash :
	{
		properties		: 'Propri챕t챕s de l\'animation Flash',
		propertiesTab	: 'Properties', // MISSING
		title			: 'Propri챕t챕s de l\'animation Flash',
		chkPlay			: 'Lecture automatique',
		chkLoop			: 'Boucle',
		chkMenu			: 'Activer le menu Flash',
		chkFull			: 'Allow Fullscreen', // MISSING
 		scale			: 'Affichage',
		scaleAll		: 'Par d챕faut (tout montrer)',
	...
	spellCheck :
	{
		...
		progress		: 'V챕rification d\'orthographe en cours...',
		noMispell		: 'V챕rification d\'orthographe termin챕e: pas d\'erreur trouv챕e',
		noChanges		: 'V챕rification d\'orthographe termin챕e: Pas de modifications',
		oneChange		: 'V챕rification d\'orthographe termin챕e: Un mot modifi챕',
		manyChanges		: 'V챕rification d\'orthographe termin챕e: %1 mots modifi챕s',
		ieSpellDownload	: 'Le Correcteur d\'orthographe n\'est pas install챕. Souhaitez-vous le t챕l챕charger maintenant?'
	},

	smiley :
	{
		toolbar	: 'Emoticon',
		title	: 'Ins챕rer un Emoticon',
	...
	numberedlist	: 'Liste num챕rot챕e',
	bulletedlist	: 'Liste 횪 puces',
	...
	{
		title		: 'Coller',
		cutError	: 'Les param챔tres de s챕curit챕 de votre navigateur emp챗chent l\'챕diteur de couper automatiquement vos donn챕es. Veuillez utiliser les 챕quivalents claviers (Ctrl/Cmd+X).',
		copyError	: 'Les param챔tres de s챕curit챕 de votre navigateur emp챗chent l\'챕diteur de copier automatiquement vos donn챕es. Veuillez utiliser les 챕quivalents claviers (Ctrl/Cmd+C).',
		...
		securityMsg	: 'A cause des param챔tres de s챕curit챕 de votre navigateur, l\'챕diteur ne peut acc챕der au presse-papier directement. Vous devez coller 횪 nouveau le contenu dans cette fen챗tre.',
	...
	pastefromword :
	{
		...
		toolbar			: 'Coller en tant que Word (format챕)',
		title			: 'Coller en tant que Word (format챕)',
	...
	{
		button			: 'Mod챔les',
		title			: 'Mod챔les de contenu',
		options : 'Template Options', // MISSING
		insertOption	: 'Remplacer tout le contenu actuel',
		selectPromptMsg	: 'S챕lectionner le mod챔le 횪 ouvrir dans l\'챕diteur<br>(le contenu actuel sera remplac챕):',
	...
	colorButton :
	{
		textColorTitle	: 'Couleur de caract챔re',
