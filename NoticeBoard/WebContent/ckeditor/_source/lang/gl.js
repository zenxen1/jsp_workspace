...
CKEDITOR.lang['gl'] =
{
	...
	horizontalrule	: 'Inserir Li챰a Horizontal',
	pagebreak		: 'Inserir Salto de P찼xina',
	pagebreakAlt		: 'Page Break', // MISSING
	unlink			: 'Eliminar Ligaz처n',
	undo			: 'Desfacer',
	redo			: 'Refacer',
	...
	common :
	{
		...
		protocol		: 'Protocolo',
		upload			: 'Carregar',
		uploadSubmit	: 'Enviar 처 Servidor',
		image			: 'Imaxe',
		flash			: 'Flash',
		form			: 'Formulario',
		checkbox		: 'Cadro de Verificaci처n',
		radio			: 'Bot처n de Radio',
		textField		: 'Campo de Texto',
		textarea		: '횁rea de Texto',
		hiddenField		: 'Campo Oculto',
		button			: 'Bot처n',
		select			: 'Campo de Selecci처n',
		imageButton		: 'Bot처n de Imaxe',
		notSet			: '<non definido>',
		id				: 'Id',
		name			: 'Nome',
		langDir			: 'Orientaci처n do Idioma',
		langDirLtr		: 'Esquerda a Dereita (LTR)',
		langDirRtl		: 'Dereita a Esquerda (RTL)',
		langCode		: 'C처digo do Idioma',
		longDescr		: 'Descrici처n Completa da URL',
	...
	specialChar		:
	{
		toolbar		: 'Inserir Car찼cter Especial',
	...
	link :
	{
		toolbar		: 'Inserir/Editar Ligaz처n',
		other 		: '<outro>',
		menu		: 'Editar Ligaz처n',
		title		: 'Ligaz처n',
		info		: 'Informaci처n da Ligaz처n',
		target		: 'Destino',
		upload		: 'Carregar',
		advanced	: 'Advanzado',
		type		: 'Tipo de Ligaz처n',
		toUrl		: 'URL', // MISSING
		toAnchor	: 'Referencia nesta p찼xina',
		toEmail		: 'E-Mail',
		targetFrame		: '<frame>',
		targetPopup		: '<Xanela Emerxente>',
		targetFrameName	: 'Nome do Marco Destino',
		targetPopupName	: 'Nome da Xanela Emerxente',
		popupFeatures	: 'Caracter챠sticas da Xanela Emerxente',
		popupResizable	: 'Resizable', // MISSING
		popupStatusBar	: 'Barra de Estado',
		popupLocationBar: 'Barra de Localizaci처n',
		...
		popupLeft		: 'Posici처n Esquerda',
		popupTop		: 'Posici처n dende Arriba',
		id				: 'Id', // MISSING
		langDir			: 'Orientaci처n do Idioma',
		langDirLTR		: 'Esquerda a Dereita (LTR)',
		langDirRTL		: 'Dereita a Esquerda (RTL)',
		...
		name			: 'Nome',
		langCode			: 'Orientaci처n do Idioma',
		tabIndex			: '횒ndice de Tabulaci처n',
		advisoryTitle		: 'T챠tulo',
		...
		noUrl			: 'Por favor, escriba a ligaz처n URL',
	...
	{
		toolbar		: 'Tabla',
		title		: 'Propiedades da T찼boa',
		menu		: 'Propiedades da T찼boa',
		deleteTable	: 'Borrar T찼boa',
		rows		: 'Filas',
		columns		: 'Columnas',
		border		: 'Tama챰o do Borde',
		widthPx		: 'pixels',
		widthPc		: 'percent',
	...
	checkboxAndRadio :
	{
		checkboxTitle : 'Propriedades do Cadro de Verificaci처n',
		radioTitle	: 'Propriedades do Bot처n de Radio',
		value		: 'Valor',
	...
	select :
	{
		title		: 'Propriedades do Campo de Selecci처n',
		selectInfo	: 'Info',
		opAvail		: 'Opci처ns Disponibles',
		value		: 'Valor',
		size		: 'Tama챰o',
		lines		: 'li챰as',
		chkMulti	: 'Permitir m첬ltiples selecci처ns',
		opText		: 'Texto',
		opValue		: 'Valor',
		btnAdd		: 'Engadir',
		btnModify	: 'Modificar',
	...
	textfield :
	{
		...
		name		: 'Nome',
		value		: 'Valor',
		charWidth	: 'Tama챰o do Caracter',
		maxChars	: 'M찼ximo de Caracteres',
		type		: 'Tipo',
		typeText	: 'Texto',
		typePass	: 'Chave'
	},
	...
	image :
	{
		...
		titleButton	: 'Propriedades do Bot처n de Imaxe',
		menu		: 'Propriedades da Imaxe',
		infoTab		: 'Informaci처n da Imaxe',
		btnUpload	: 'Enviar 처 Servidor',
		upload		: 'Carregar',
		alt			: 'Texto Alternativo',
		lockRatio	: 'Proporcional',
		resetSize	: 'Tama챰o Orixinal',
		border		: 'L챠mite',
		hSpace		: 'Esp. Horiz.',
		vSpace		: 'Esp. Vert.',
	...
	flash :
	{
		...
		hSpace			: 'Esp. Horiz.',
		vSpace			: 'Esp. Vert.',
		validateSrc		: 'Por favor, escriba a ligaz처n URL',
	...
	spellCheck :
	{
		toolbar			: 'Correcci처n Ortogr찼fica',
		title			: 'Spell Check', // MISSING
		notAvailable	: 'Sorry, but service is unavailable now.', // MISSING
		errorLoading	: 'Error loading application service host: %s.', // MISSING
		notInDic		: 'Non est찼 no diccionario',
		changeTo		: 'Cambiar a',
		btnIgnore		: 'Ignorar',
		...
		progress		: 'Correcci처n ortogr찼fica en progreso...',
		noMispell		: 'Correcci처n ortogr찼fica rematada: Non se atoparon erros',
		noChanges		: 'Correcci처n ortogr찼fica rematada: Non se substituiu nengunha verba',
		oneChange		: 'Correcci처n ortogr찼fica rematada: Unha verba substituida',
		manyChanges		: 'Correcci처n ortogr찼fica rematada: %1 verbas substituidas',
		ieSpellDownload	: 'O corrector ortogr찼fico non est찼 instalado. 쩔Quere descargalo agora?'
	},
	...
	justify :
	{
		left	: 'Ali챰ar 찼 Esquerda',
		center	: 'Centrado',
		right	: 'Ali챰ar 찼 Dereita',
		block	: 'Xustificado'
	},
	...
	{
		title		: 'Pegar',
		cutError	: 'Os axustes de seguridade do seu navegador non permiten que o editor realice autom찼ticamente as tarefas de corte. Por favor, use o teclado para iso (Ctrl/Cmd+X).',
		copyError	: 'Os axustes de seguridade do seu navegador non permiten que o editor realice autom찼ticamente as tarefas de copia. Por favor, use o teclado para iso (Ctrl/Cmd+C).',
	...
	docprops :
	{
		...
		chooseColor : 'Choose', // MISSING
		other : '<outro>',
		docTitle :	'T챠tulo da P찼xina',
		charset : 	'Codificaci처n do Xogo de Caracteres',
		charsetOther : 'Outra Codificaci처n do Xogo de Caracteres',
		...
		xhtmlDec : 'Incluir Declaraci처ns XHTML',
		bgColor : 'Cor de Fondo',
		bgImage : 'URL da Imaxe de Fondo',
		bgFixed : 'Fondo Fixo',
		txtColor : 'Cor do Texto',
		margin : 'Marxes da P찼xina',
		marginTop : 'Arriba',
		marginLeft : 'Esquerda',
		marginRight : 'Dereita',
		marginBottom : 'Abaixo',
		metaKeywords : 'Palabras Chave de Indexaci처n do Documento (separadas por comas)',
		metaDescription : 'Descripci처n do Documento',
		metaAuthor : 'Autor',
