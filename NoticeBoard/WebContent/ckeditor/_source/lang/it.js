...
CKEDITOR.lang['it'] =
{
	...
	common :
	{
		...
		validateNumberFailed : 'Il valore inserito non 챔 un numero.',
		confirmNewPage	: 'Ogni modifica non salvata sar횪 persa. Sei sicuro di voler caricare una nuova pagina?',
		...
		invalidCssLength	: 'Il valore indicato per il campo "%1" deve essere un numero positivo con o senza indicazione di una valida unit횪 di misura per le classi CSS (px, %, in, cm, mm, em, ex, pt, o pc).',
		invalidHtmlLength	: 'Il valore indicato per il campo "%1" deve essere un numero positivo con o senza indicazione di una valida unit횪 di misura per le pagine HTML (px o %).',
		invalidInlineStyle	: 'Il valore specificato per lo stile inline deve consistere in una o pi첫 tuple con il formato di "name : value", separati da semicolonne.',
		cssLengthTooltip	: 'Inserisci un numero per il valore in pixel oppure un numero con una valida unit횪 CSS (px, %, in, cm, mm, ex, pt, o pc).',
	...
	contextmenu :
	{
		options : 'Opzioni del men첫 contestuale'
	},
	...
	anchor :
	{
		...
		menu		: 'Propriet횪 ancora',
		title		: 'Propriet횪 ancora',
		name		: 'Nome ancora',
	...
	list:
	{
		numberedTitle		: 'Propriet횪 liste numerate',
		bulletedTitle		: 'Propriet횪 liste puntate',
		type				: 'Tipo',
		start				: 'Inizio',
	...
	findAndReplace :
	{
		...
		notFoundMsg			: 'L\'elemento cercato non 챔 stato trovato.',
	...
	{
		toolbar		: 'Tabella',
		title		: 'Propriet횪 tabella',
		menu		: 'Propriet횪 tabella',
		...
		cell :
		{
			...
			title			: 'Propriet횪 della cella',
			cellType		: 'Tipo di cella',
			rowSpan			: 'Su pi첫 righe',
			colSpan			: 'Su pi첫 colonne',
	...
	checkboxAndRadio :
	{
		checkboxTitle : 'Propriet횪 checkbox',
		radioTitle	: 'Propriet횪 radio button',
		value		: 'Valore',
	...
	form :
	{
		title		: 'Propriet횪 modulo',
		menu		: 'Propriet횪 modulo',
		action		: 'Azione',
		method		: 'Metodo',
		encoding	: 'Codifica'
	},
	...
	select :
	{
		title		: 'Propriet횪 menu di selezione',
		selectInfo	: 'Info',
	...
	textfield :
	{
		title		: 'Propriet횪 campo di testo',
		name		: 'Nome',
		value		: 'Valore',
		charWidth	: 'Larghezza',
	...
	hidden :
	{
		title	: 'Propriet횪 campo nascosto',
		name	: 'Nome',
		value	: 'Valore'
	},
	...
	image :
	{
		title		: 'Propriet횪 immagine',
		titleButton	: 'Propriet횪 bottone immagine',
		menu		: 'Propriet횪 immagine',
	...
	flash :
	{
		properties		: 'Propriet횪 Oggetto Flash',
		propertiesTab	: 'Propriet횪',
		title			: 'Propriet횪 Oggetto Flash',
		chkPlay			: 'Avvio Automatico',
		chkLoop			: 'Riavvio automatico',
		chkMenu			: 'Abilita Menu di Flash',
		chkFull			: 'Permetti la modalit횪 tutto schermo',
 		scale			: 'Ridimensiona',
	...
	spellCheck :
	{
		...
		notAvailable	: 'Il servizio non 챔 momentaneamente disponibile.',
	...
	clipboard :
	{
		...
		securityMsg	: 'A causa delle impostazioni di sicurezza del browser,l\'editor non 챔 in grado di accedere direttamente agli appunti. E\' pertanto necessario incollarli di nuovo in questa finestra.',
		pasteArea	: 'Incolla'
	},
	...
	pastefromword :
	{
		...
		error			: 'Non 챔 stato possibile eliminarre il testo incollato a causa di un errore interno.'
	},
	...
	templates :
	{
		...
		selectPromptMsg	: 'Seleziona il modello da aprire nell\'editor<br />(il contenuto attuale verr횪 eliminato):',
	...
	scayt :
	{
		...
		emptyDic		: 'Il nome del dizionario non pu챵 essere vuoto.',
		noSuggestions	: 'Nessun suggerimento',
		optionsTab		: 'Opzioni',
		...
		dic_delete		: 'Cancella',
		dic_rename		: 'Rinomina',
		dic_info		: 'Inizialmente il dizionario utente 챔 memorizzato in un Cookie. I Cookie per챵 hanno una dimensioni massima limitata. Quando il dizionario utente creasce a tal punto da non poter pi첫 essere memorizzato in un Cookie, allora il dizionario pu챵 essere memorizzato sul nostro server. Per memorizzare il proprio dizionario personale sul nostro server, 챔 necessario specificare un nome per il proprio dizionario. Se avete gi횪 memorizzato un dizionario, inserite il nome che gli avete dato e premete il pulsante Ripristina.',
	...
	docprops :
	{
		label : 'Propriet횪 del Documento',
		title : 'Propriet횪 del Documento',
		design : 'Disegna',
		meta : 'Meta Data',
		chooseColor : 'Scegli',
		other : '<altro>',
		...
		previewHtml : '<p>Questo 챔 un <strong>testo di esempio</strong>. State usando <a href="javascript:void(0)">CKEditor</a>.</p>'
	}
};
