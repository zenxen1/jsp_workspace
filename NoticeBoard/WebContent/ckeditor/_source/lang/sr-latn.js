...
CKEDITOR.lang['sr-latn'] =
{
	...
	link :
	{
		...
		targetFrameName	: 'Naziv odredi큄nog frejma',
	...
	select :
	{
		...
		size		: 'Veli훾ina',
		lines		: 'linija',
		chkMulti	: 'Dozvoli vi큄estruku selekciju',
		opText		: 'Tekst',
		opValue		: 'Vrednost',
		btnAdd		: 'Dodaj',
		btnModify	: 'Izmeni',
		btnUp		: 'Gore',
		btnDown		: 'Dole',
		btnSetValue : 'Podesi kao ozna훾enu vrednost',
		btnDelete	: 'Obri큄i'
	},
	...
	spellCheck :
	{
		...
		notInDic		: 'Nije u re훾niku',
		changeTo		: 'Izmeni',
		btnIgnore		: 'Ignori큄i',
		btnIgnoreAll	: 'Ignori큄i sve',
		btnReplace		: 'Zameni',
		btnReplaceAll	: 'Zameni sve',
		btnUndo			: 'Vrati akciju',
		noSuggestions	: '- Bez sugestija -',
		progress		: 'Provera spelovanja u toku...',
		noMispell		: 'Provera spelovanja zavr큄ena: gre큄ke nisu pronadene',
		noChanges		: 'Provera spelovanja zavr큄ena: Nije izmenjena nijedna rec',
		oneChange		: 'Provera spelovanja zavr큄ena: Izmenjena je jedna re훾',
		manyChanges		: 'Provera spelovanja zavr큄ena: %1 re훾(i) je izmenjeno',
		ieSpellDownload	: 'Provera spelovanja nije instalirana. Da li 탑elite da je skinete sa Interneta?'
	},
	...
	{
		title		: 'Zalepi',
		cutError	: 'Sigurnosna pode큄avanja Va큄eg pretra탑iva훾a ne dozvoljavaju operacije automatskog isecanja teksta. Molimo Vas da koristite pre훾icu sa tastature (Ctrl/Cmd+X).',
		copyError	: 'Sigurnosna pode큄avanja Va큄eg pretra탑iva훾a ne dozvoljavaju operacije automatskog kopiranja teksta. Molimo Vas da koristite pre훾icu sa tastature (Ctrl/Cmd+C).',
		pasteMsg	: 'Molimo Vas da zalepite unutar donje povrine koriste훶i tastaturnu pre훾icu (<STRONG>Ctrl/Cmd+V</STRONG>) i da pritisnete <STRONG>OK</STRONG>.',
	...
	pasteText :
	{
		button	: 'Zalepi kao 훾ist tekst',
		title	: 'Zalepi kao 훾ist tekst'
	},

	templates :
	{
		button			: 'Obrasci',
		title			: 'Obrasci za sadr탑aj',
		options : 'Template Options', // MISSING
		insertOption	: 'Replace actual contents', // MISSING
		selectPromptMsg	: 'Molimo Vas da odaberete obrazac koji ce biti primenjen na stranicu (trenutni sadr탑aj ce biti obrisan):',
	...
	fontSize :
	{
		label		: 'Veli훾ina fonta',
		voiceLabel	: 'Font Size', // MISSING
		panelTitle	: 'Veli훾ina fonta'
	},
	...
	docprops :
	{
		...
		marginRight : 'Desna',
		marginBottom : 'Donja',
		metaKeywords : 'Klju훾ne reci za indeksiranje dokumenta (razdvojene zarezima)',
