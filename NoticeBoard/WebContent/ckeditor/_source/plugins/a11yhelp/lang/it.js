...
CKEDITOR.plugins.setLang( 'a11yhelp', 'it',
{
	accessibilityHelp :
	{
		title : 'Istruzioni di Accessibilit횪',
				...
				items :
						[
...

							{
								...
								legend :
									'Dentro un box-lista, muoviti al prossimo elemento della lista con TAB o con la Freccia direzionale gi첫. Spostati all\'elemento precedente con MAIUSC+TAB oppure con Freccia direzionale sopra. Premi SPAZIO o INVIO per scegliere l\'opzione della lista. Premi ESC per chiudere il box-lista.'
							},
