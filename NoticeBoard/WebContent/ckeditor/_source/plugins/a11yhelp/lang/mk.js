...
CKEDITOR.plugins.setLang( 'a11yhelp', 'mk',
{
	accessibilityHelp :
	{
		title : '�샫싼곎귂��꺪붇녡먁� 鈞逵 極�龜�곎궿겆왈싻앗곎�',
		contents : '鬼棘畇�菌龜戟逵 戟逵 畇筠剋棘�� 鈞逵 極棘劇棘��. �쀐� 畇逵 均棘 鈞逵�궿꽥앗�龜�궿� 棘勻棘�� 畇龜�샫겆뿅앗� 極�龜�궿먈곍싻둘궿� ESC.',
		legend :
		[
			{
				name : '�왧왐댮궿�',
